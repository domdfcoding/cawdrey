...
description_block = """Several useful custom dictionaries for Python.
...
source:
  url: "https://pypi.io/packages/source/c/cawdrey/cawdrey-{__version__}.tar.gz"
...
about:
  home: "https://github.com/domdfcoding/cawdrey"
  license: "GNU Lesser General Public License v3 or later (LGPLv3+)"
  # license_family: LGPL
  # license_file: LICENSE
  summary: "Several useful custom dictionaries for Python 📖 🐍"
  description: "{description_block}"
  doc_url: https://cawdrey.readthedocs.io
  dev_url: https://github.com/domdfcoding/cawdrey
